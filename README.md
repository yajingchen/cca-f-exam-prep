...
│   └── 024_claude-code_app-starter-TDD/ # TDD variant: document tools MCP server with pytest suite
│
...
.github/
└── workflows/
    ├── claude.yml                     # Claude PR Assistant — auto-responds to PR comments
    └── claude-code-review.yml         # Claude Code Review — runs automated review on PRs
```
