...
│   ├── 024_claude-code_app-starter/   # Claude Code app starter — template with CLAUDE.md and prompts (Python, uv)
│   └── 024_claude-code_app-starter-TDD/ # Claude Code app starter — TDD solution (Python, uv)
│
