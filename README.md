...
│   ├── 024_claude-code_app-starter/      # Document tools MCP server — open-ended build (Python, uv)
│   └── 024_claude-code_app-starter-TDD/  # Same project, TDD approach — tests written first (Python, uv)
│
└── Claude Code in Action/             # Claude Code workflows and agentic patterns
    ├── 000_Video Course Notes – Claude Code in Action.md
    ├── 001_uigen/                     # UI generator (Next.js, @ai-sdk/anthropic, Prisma)
