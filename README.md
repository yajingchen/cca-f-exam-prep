...
│   └── 024_claude-code_app-starter-TDD/  # TDD variant: document tools with pytest (Python, uv)
│
└── Claude Code in Action/             # Claude Code workflows and agentic patterns
    ├── 000_Video Course Notes – Claude Code in Action.md
    ├── 001_uigen/                     # UI generator (Next.js, @ai-sdk/anthropic, Prisma/SQLite)
...
# TDD variant (document tools + pytest)
...
npm install
npx prisma migrate dev   # initializes the SQLite database
