...
└── Claude Code in Action/             # Claude Code workflows and agentic patterns
    ...
    ├── 001_uigen/                     # UI generator (Next.js, Prisma/SQLite, auth, @ai-sdk/anthropic)
    └── 002_queries/                   # E-commerce NL query engine (TypeScript, Claude Agent SDK, SQLite)
...
`001_uigen` requires a full setup that installs dependencies, generates the Prisma client, and runs DB migrations:
...
`002_queries` is a TypeScript e-commerce query engine backed by SQLite:
