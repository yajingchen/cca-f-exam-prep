...
│   ├── 024_claude-code_app-starter/   # Claude Code app starter (Python, uv) — starter scaffold
│   └── 024_claude-code_app-starter-TDD/  # TDD variant: tests-first MCP document tools server (Python, uv)
│
└── Claude Code in Action/             # Claude Code workflows and agentic patterns
    ...
    └── 002_queries/                   # NL e-commerce queries (TypeScript, Claude Agent SDK, SQLite)
                                       #   + Slack alerts for overdue orders + CC hooks (query/read/tsc)
