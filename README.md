...
│   ├── 024_claude-code_app-starter/   # Claude Code app starter (Python, uv) — with CLAUDE.md
│   └── 024_claude-code_app-starter-TDD/  # Same app starter built TDD-first (Python, uv)
│
└── Claude Code in Action/             # Claude Code workflows and agentic patterns
    ...
    └── 002_queries/                   # NL→SQL e-commerce queries (TypeScript, Claude Agent SDK, SQLite, Slack alerts)
...
# Claude Code app starter (choose one):
