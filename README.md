...
│   └── 024_claude-code_app-starter-TDD/  # TDD variant: document-tools MCP server with pytest suite (Python, uv)
│
...
.github/
└── workflows/
    ├── claude.yml                     # Claude Code assistant on issues & PR review comments
