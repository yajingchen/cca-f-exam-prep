...
│   ├── 024_claude-code_app-starter/   # Claude Code app starter — Document Tools MCP server (Python, uv)
│   └── 024_claude-code_app-starter-TDD/ # Same project rebuilt with TDD approach (Python, uv)
│
