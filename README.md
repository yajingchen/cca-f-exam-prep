...
└── Claude Code in Action/             # Claude Code workflows and agentic patterns
    ...
    ├── 001_uigen/                     # UI generator (Next.js, @ai-sdk/anthropic, Prisma, auth)
...
.github/
└── workflows/
    ├── claude.yml                     # Claude PR assistant (responds to issue/PR comments)
...
npm install
# or use the setup script which also initializes the Claude config:
npm run setup
```
