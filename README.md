...
│   └── 024_claude-code_app-starter-TDD/ # App starter — TDD practice variant (Python, uv)
│
...
.github/
└── workflows/
    ├── claude-code-review.yml         # Runs Claude Code Review plugin on every PR
    └── claude.yml                     # Claude Code GitHub Action (@claude mention handler)
```
